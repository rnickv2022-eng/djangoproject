...
4. category_detail.html -  <h6 class="card-subtitle mb-2 text" style="color: green;">Опубликована</h6>
<h6 class="card-subtitle mb-2" style="color: red;">Неопубликована </h6> - изменил цвет в зависисмости от Опубликовано/неопубликовано
